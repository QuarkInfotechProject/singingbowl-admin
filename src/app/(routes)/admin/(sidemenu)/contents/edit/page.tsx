...
const Contentsedit = ({  setIsSheetOpens,dataId,setRefetch }: {  setIsSheetOpens:any;dataId:any;setRefetch:any; }) => {
  ...
  useEffect(() => {
    ...
    const getDatas = async () => {
      setLoading(true)
      const urls = `/api/content/show/${dataId}`;
      try {
  ...
  <RootEdit editContentData={editContentData} fileId={fileId} setIsSheetOpens={setIsSheetOpens} 
