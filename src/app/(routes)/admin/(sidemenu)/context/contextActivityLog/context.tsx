...
// Define action types
type ProcessAction = 
  | { type: 'SET_Acitivity_DATA'; payload: TransactionsResponse }
...
export const fetchActivity = async (
    ...
    try {
      const url = `/api/activity?page=${currentPage}`; 
      ...
      dispatch({ type: 'SET_Acitivity_DATA', payload: data.data });
