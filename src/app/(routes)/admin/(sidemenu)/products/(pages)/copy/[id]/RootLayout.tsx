...
const RootLayout = ({
  ...
  const setDefaultValue = (editProduct: SingleProductT) => {
    form.setValue("productName", editProduct?.productName + "-(copy)" || " ");
    form.setValue("url", editProduct?.url + "-copy" || " ");
    ...
    form.setValue("sku", editProduct.sku ? editProduct.sku + "copy" : "");
    ...
    form.setValue(
      ...
      editProduct?.files?.additionalImage?.length === 0
        ? ""
