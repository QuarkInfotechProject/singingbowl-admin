...
// async function fetchData(): Promise<ColorData> {
//   try {
...
//   dataPromise: Promise<ColorData>;
// }

// // Properly type the DataDisplay component
// const DataDisplay: React.FC<DataDisplayProps> = ({ dataPromise }) => {
//   const data = use(dataPromise); // Using React's `use` hook to resolve the promise
...
// // Main page component that renders the content based on the fetched data
// const Page = (): JSX.Element => {


//   // Create the data promise using the fetchData function
