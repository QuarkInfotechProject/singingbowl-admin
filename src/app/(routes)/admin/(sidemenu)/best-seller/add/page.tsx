...
const RootCreate = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const { data } = await axios.post("/api/bestSeller/add", fromData);
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Add Best Seller</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          onBlur={() => {
                            field.onBlur();
                            form.trigger("name"); // Trigger validation on blur
                          }}
                        />
                      </FormControl>
                      <FormDescription></FormDescription>
