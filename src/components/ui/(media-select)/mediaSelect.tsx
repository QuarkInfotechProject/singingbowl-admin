...
const AllImages = ({
 ...
 const [localAdditionalThumbnails, setLocalAdditionalThumbnails] = useState<
   string[]
 >([]);
 const [localDescriptionThumbnails, setLocalDescriptionThumbnails] = useState("");
 ...
 const [filters, setFilters] = useState<ImgFilterT>({
  ...
  console.log("here  image select dasta",localBaseImage)
  const handleConfirmUpload = (toUpdate: "base" | "additional" | "descriptions") => {
    if (toUpdate === "base") {
                    ...
                    <div className="w-4/5">
                      <p className="mb-2 font-medium">
                        ...
                        {toUpdate === "additional" ? (
                          ...
                          >
                            {localAdditionalIds.length + uploadedImages.length}/
                            {total}
                          </span>
                          ...
                          <span>{localBaseThumbnail.length > 0 ? 1 : 0} / 1</span>
                        )}
                      </p>
                      <div className="bg-gray-100 min-h-[80px] p-2">
                        {localBaseThumbnail.length > 0 && (
                          ...
                          // id={editMediaData?.data?.id}
                            ...
                            playsInline
                          >
                          <source src={localBaseThumbnail} type="video/mp4" />
...
{localDescriptionThumbnails.length > 0  &&(
        <div className="flex max-w-[900px] overflow-x-auto pb-4 gap-6 px-2">
          {/* {localDescriptionThumbnails.map((url, index) => ( */}
            {/* <div key={index} className="relative flex-shrink-0"> */}
              <div className="relative w-24 h-24 rounded-lg overflow-hidden shadow-md">
                {localDescriptionThumbnails?.endsWith('.mp4') ? (
                  <video
                    ...
                    playsInline
                  >
                    <source src={localDescriptionThumbnails} type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                ) : (
                  <img
          ...
          {/* ))} */}
                    ...
                    <div className="w-1/5 flex flex-col gap-4">
                      <Button
                        ...
                        disabled={
                          (toUpdate === "base" && localBaseThumbnail.length === 0) ||
                          (toUpdate === "additional" && localAdditionalThumbnails.length === 0) ||
                          (toUpdate === "descriptions" && localDescriptionThumbnails.length === 0)
                        }
                        size="sm"
                      >
